...
This project implements a sentiment analysis system to classify restaurant reviews as positive or negative using Natural Language Processing (NLP) and Machine Learning techniques.
...
Outcome:
The project demonstrates a reproducible and interpretable sentiment analysis pipeline suitable for real-world customer feedback analysis.
